<div class="content">
	<div class="container-fluid">
		<div class="btn-group">
		  <a href="<?php echo base_url('index.php/adminxmaps'); ?>" type="button" class="btn btn-primary">Suhu</a>
		  <a href="<?php echo base_url('index.php/adminxmaps/mapGas'); ?>" type="button" class="btn btn-primary">Gas</a>
		  <a href="<?php echo base_url('index.php/adminxmaps/mapKelembaban'); ?>" type="button" class="btn btn-primary" disabled>Kelembaban</a>
		  <br/>
		</div>
		<div class="card card-map">
			<div class="header">
				<h4 class="title">Map Kelembaban (Semua Agent)</h4>
				<table>
					<tr>
  ...
  var citymap = {
	  <?php foreach($konten as $data){
		if($data['kelembaban']>40){
			$warna="#fc96a3";
		}elseif($data['kelembaban']>35){
			$warna="#ef0208";
		}elseif($data['kelembaban']>30){
			$warna="#ffa800";
		}elseif($data['kelembaban']>25){
			$warna="#bbff00";
		}elseif($data['kelembaban']>20){
			$warna="#0efc00";
		}elseif($data['kelembaban']>15){
			$warna="#00feda";
		}elseif($data['kelembaban']>10){
			$warna="#04a0ff";
		}elseif($data['kelembaban']<10){
			$warna="#0061f3";
		}
