<div class="content">
	<div class="container-fluid">
		<div class="btn-group">
		  ...
		  <a href="<?php echo base_url('index.php/adminxmaps/mapGas'); ?>" type="button" class="btn btn-primary" disabled>Gas</a>
		  <a href="<?php echo base_url('index.php/adminxmaps/mapKelembaban'); ?>" type="button" class="btn btn-primary">Kelembaban</a>
		  <br/>
		</div>
		<div class="card card-map">
			<div class="header">
				<h4 class="title">Map Gas (Semua Agent)</h4>
				<table>
					<tr>
