<div class="content">
	<div class="container-fluid">
		<div class="btn-group">
		  ...
		  <a href="<?php echo base_url('index.php/user/mapGas'); ?>" type="button" class="btn btn-primary">Gas</a>
		  <a href="<?php echo base_url('index.php/user/mapKelembaban'); ?>" type="button" class="btn btn-primary" disabled>Kelembaban</a>
		  <br/>
		</div>
		<div class="card card-map">
			<div class="header">
				<h4 class="title">Map Kelembaban (Hanya Alat Anda)</h4>
				<table>
					<tr>
